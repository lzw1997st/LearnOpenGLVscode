 ...
 * @LastEditTime: 2023-07-22 23:02:12
...
int main()
{
    ...
    Shader ourShader1("./src/03_shader_glsl/shader/vertex.glsl", "./src/03_shader_glsl/shader/fragment.glsl");
    Shader ourShader2("./src/03_shader_glsl/shader/vertex.glsl", "./src/03_shader_glsl/shader/fragment.glsl");
