 ...
 * @LastEditTime: 2023-07-23 12:52:17
...
int main()
{
    ...
    //Shader ourShader1("./src/05_load_texture/shader/vertex.glsl", "./src/05_load_texture/shader/fragment.glsl");
    Shader ourShader2("./src/05_load_texture/shader/vertex.glsl", "./src/05_load_texture/shader/fragment.glsl");
